...
def _q1_obedience():
    """
    >>> sql = sql_fixture(); \
        sql('SELECT * FROM obedience LIMIT 10;')
    семь|фотка 2
    число 7 из предложенных ниже вариантов|фотка 2
    число 7 из предложенных ниже вариантов|фотка 1
    число 7 из предложенных ниже вариантов|фотка 5
    число 7 из предложенных ниже вариантов|фотка 1
    другой вариант|фотка 1
    другой вариант|фотка 5
    7|фотка 4
    число 7 из предложенных ниже вариантов|фотка 4
    ты мне не начальник!|фотка 3
    """
    pass

def _q2_smallest_int():
    """
    >>> sql = sql_fixture(); sql('SELECT * FROM smallest_int;')
    01.12.2019 11:19:40|3
    01.12.2019 11:22:55|3
    01.12.2019 21:26:15|3
    02.12.2019 23:51:11|3
    01.12.2019 10:01:57|4
    01.12.2019 10:07:23|4
    01.12.2019 10:24:55|4
    01.12.2019 9:53:55|4
    01.12.2019 9:54:29|4
    01.12.2019 9:55:38|4
    02.12.2019 9:39:38|4
    01.12.2019 9:51:56|6
    01.12.2019 10:26:28|8
    01.12.2019 9:53:08|8
    02.12.2019 23:50:56|8
    03.12.2019 3:15:05|9
    01.12.2019 21:36:06|11
    01.12.2019 1:46:31|15
    02.12.2019 23:56:25|22
    03.12.2019 0:04:02|23
    """

def _q3_smallest_int():
    """
    >>> sql = sql_fixture(); sql('SELECT * FROM matchmaker LIMIT 10;')
    собака|smells like teen spirit - nirvana|синий|фиолетовый
    енот|smells like teen spirit - nirvana|черный|синий
    енот|smells like teen spirit - nirvana|черный|розовый
    енот|smells like teen spirit - nirvana|синий|розовый
    пингвин|bohemian rhapsody — queen|бордовый|синий
    """
    pass

def _q4_smallest_int_having():
    """
    >>> sql = sql_fixture(); sql('SELECT * FROM smallest_int_having LIMIT 48')
    01.12.2019 9:52:56|1e-07
    01.12.2019 9:51:56|6
    03.12.2019 3:15:05|9
    01.12.2019 21:36:06|11
    01.12.2019 1:46:31|15
    02.12.2019 23:56:25|22
    03.12.2019 0:04:02|23
    02.12.2019 23:53:03|38
    03.12.2019 0:34:17|454
    03.12.2019 7:03:52|534
    """
    pass

def _q5_lets_count():
    """
    >>> sql = sql_fixture(); sql('SELECT * from fa19favpets;');\
        sql('SELECT * from fa19dog;');\
        sql('SELECT * from obedienceimages;')
    собака|3
    питон|3
    кот|3
    енот|3
...
def sql_fixture():
    import sqlite_shell
    def executor(cmd):
        sqlite_shell.main('empty','-init', 'lab_12.sql', '', cmd)
    return executor
